...
Three output files:
  ...
  data/traffic_hourly_sydney_{YEAR}.csv      (14 cols)  hourly traffic, long format
  data/yearly_summary_sydney_{YEAR}.csv      (10 cols)  annual summary (AADT)
"""
...
def main():
    print("=" * 60)
    print(f"NSW Traffic Benchmark Data -- {YEARS} (cleaned)")
